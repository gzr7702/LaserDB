    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing_address', models.ForeignKey(related_name='address_billing', to='service_orders.Address')),
                ('street_address', models.ForeignKey(related_name='address_street', to='service_orders.Address')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parts', models.OneToOneField(null=True, to='service_orders.Part')),
            ],
            options={
            },
            bases=(models.Model,),
